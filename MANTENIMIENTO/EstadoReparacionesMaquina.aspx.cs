...
{
    public partial class EstadoReparacionesMaquina : System.Web.UI.Page
    {
        ...
        protected void GridView_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (AccVencidas.Text == "Rep. iniciada")
                    { 
                    AccVencidas.Visible = true;
                    AccVencidas.ForeColor = System.Drawing.Color.Blue;
                    }
                if (AccVencidas.Text == "En curso")
                {
                    AccVencidas.Visible = true;
                    AccVencidas.ForeColor = System.Drawing.Color.Green;
                }
