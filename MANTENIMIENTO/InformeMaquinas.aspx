<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="InformeMaquinas.aspx.cs" Inherits="ThermoWeb.MANTENIMIENTO.InformesMaquinas" MasterPageFile="~/SMARTH.Master"
    EnableEventValidation="false" MaintainScrollPositionOnPostback="true" %>

<asp:Content ID="Cabecera" ContentPlaceHolderID="HeadContent" runat="server">
    <title>Informe de máquinas</title>
    <link rel="shortcut icon" type="image/x-icon" href="FAVICON.ico" />
</asp:Content>
<asp:Content ID="NavbarAPP" ContentPlaceHolderID="NavbarAPP" runat="server">
    &nbsp- Informes de máquinas
</asp:Content>
    ...
    <div class="d-flex" id="wrapper">
        <div class="flex-shrink-0 p-3 bg-dark shadow-sm" style="width: 240px;">
            ...
            <div class="collapse" id="collapseExample">
                <div class="mt-2"><a class="btn-sm btn-outline-light border-0 ms-4" href="../MANTENIMIENTO/ReparacionMaquinas.aspx" role="button" style="width: 90%; text-align: start; text-decoration:none"><i class="bi bi-arrow-right-circle me-2"></i>Mant. Máquinas</a><br /></div>
        ...
        <div class="flex-fill" id="page-content-wrapper">
            ...
            <div class="nav nav-pills me-3 " id="v-pills-tab" role="tablist">
                <br />
                <button class="nav-link  active" id="PILLMOLREPARAR" runat="server" data-bs-toggle="pill" data-bs-target="#v-pills-tab1" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false" style="text-align: start; font-weight: 600"><i class="bi bi-grid-1x2 me-2"></i>General máquina</button>
            ...
            <div class="tab-content col-12" id="v-pills-tabContent">
                            ...
                            <asp:GridView ID="dgv_Listadomaquinas" runat="server" AllowSorting="True" margin="20px" Style="margin-left: 1%;"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="ID" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblID" runat="server" Text='<%#Eval("IdMaquinaCHAR") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Máquina">
                                        <ItemTemplate>
                                            <asp:Label ID="lblMaquina" runat="server" Font-Size="Large" Text='<%#Eval("Maquina") + " ("+Eval("NumSerie")+")" %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Nº Reparaciones" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:Label ID="lblReparaciones" runat="server" Text='<%#Eval("NumReparaciones") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
                ...
                <div class="tab-pane fade" id="v-pills-tab2" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                    <a href="http://facts4-srv/thermogestion/DOCUMENTAL/DOCUMENTOS/FrecuenciasPreventivo.pdf" class="mt-4" style="font: bold; font-size: large; color: black"><i class="bi bi-file-earmark-font ms-4"></i>Consultar tabla estándar preventivo</a>
                    <div class="table-responsive">
                        <asp:GridView ID="dgv_ListadoPreventivomaquinas" runat="server" AllowSorting="True" margin="20px" Style="margin-left: 1%;"
                            Width="98.5%" CssClass="table table-responsive shadow p-3 mb-5 rounded border-top-0" AutoGenerateColumns="false" OnRowCommand="GridViews_RowCommandReset"
                            EmptyDataText="No hay moldes para mostrar.">
                            <HeaderStyle CssClass="card-header" BackColor="#0d6efd" Font-Bold="True" ForeColor="White" HorizontalAlign="Center" Height="40px" />
                            <RowStyle BackColor="White" />
                            <AlternatingRowStyle BackColor="#e6e6e6" />
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Tipo de mantenimiento" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:Label ID="lblTipoMant" Font-Size="X-Large" runat="server" Text='<%#Eval("THRESHOLD") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="thresholdval" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblTipoMantdd" runat="server" Text='<%#Eval("C_THRESHOLDVALUE") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Contadores">
                                    <ItemTemplate>
                                        <asp:Label ID="lblContador" runat="server" Text='<%#"<strong>Actual: </strong>" +Eval("CONTADOR") + " horas." %>' /><br />
                                        <asp:Label ID="lblContaTotal" runat="server" Text='<%#"<strong>Histórico: </strong>" +Eval("HISTORICO") + " horas." %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Ultima actualización" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Porcentaje" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:Label ID="lblPorcentaje" Font-Size="X-Large" runat="server" Text='<%#Eval("porc") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="120px">
                                    <ItemTemplate>
                                        <asp:Button ID="button2" runat="server" CommandName="Reset" type="button" class="btn btn-primary btn-sm" CommandArgument='<%#Eval("MAQUINA")+","+Eval("C_THRESHOLDVALUE")%>' Visible="false" Text="Resetear" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
                ...
                <div class="tab-pane fade" id="v-pills-tab3" role="tabpanel" aria-labelledby="v-pills-settings-tab">
                    <div class="container-fluid mt-3">
                        <div class="table-responsive">
                            <asp:GridView ID="dgv_ListadoHistoricomaquinas" runat="server" AllowSorting="True" margin="20px" Style="margin-left: 1%;"
                                Width="98.5%" CssClass="table table-responsive shadow p-3 mb-5 rounded border-top-0" AutoGenerateColumns="false" OnRowCommand="ContactsGridView_RowCommand"
                                EmptyDataText="No hay moldes para mostrar.">
                                <HeaderStyle CssClass="card-header" BackColor="#0d6efd" Font-Bold="True" ForeColor="White" HorizontalAlign="Center" Height="40px" />
                                <RowStyle BackColor="White" />
                                ...
                                <Columns>
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="LinkButton1" CssClass="btn btn-outline-dark" Font-Size="Large" runat="server" CommandName="Redirect" CommandArgument='<%#Eval("IdMantenimiento")%>'><i class="bi bi-file-post"></i></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="ID" Visible="false">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Parte" ItemStyle-HorizontalAlign="left">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Coste">
                                        <ItemTemplate>
                                            <asp:Label ID="lblcoste" Font-Size="Large" runat="server" Text='<%#Eval("ImporteEmpresa1 ", "{0:0.##€}") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
                ...
                <div class="tab-pane fade" id="v-pills-tab4" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                    <div class="container-fluid mt-3">
                        <div class="table-responsive">
                            <asp:GridView ID="dgv_historico_preventivo" runat="server" AllowSorting="True" margin="20px" Style="margin-left: 1%;"
                                Width="98.5%" CssClass="table table-responsive shadow p-3 mb-5 rounded border-top-0" AutoGenerateColumns="false" OnRowCommand="ContactsGridView_RowCommand"
                                EmptyDataText="No hay moldes para mostrar.">
                                <HeaderStyle CssClass="card-header" BackColor="#0d6efd" Font-Bold="True" ForeColor="White" HorizontalAlign="Center" Height="40px" />
                                <RowStyle BackColor="White" />
