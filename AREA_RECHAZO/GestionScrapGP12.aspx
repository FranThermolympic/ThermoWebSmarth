<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="GestionScrapGP12.aspx.cs" Inherits="ThermoWeb.AREA_RECHAZO.GestionScrapGP12" MasterPageFile="~/SMARTH.Master"
    EnableEventValidation="false" MaintainScrollPositionOnPostback="true" %>
<asp:Content ID="Cabecera" ContentPlaceHolderID="HeadContent" runat="server">
    <title>Gestión de scrap Area de Rechazo</title>
        ...
        <div class="row">
            <div class="col-lg-10">
               <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-md-3 me-md-4 mb-md-1">
                    ...
                    <button id="btnoffcanvas" runat="server" type="button" class="btn btn-primary ms-md-0 bi bi-funnel shadow-sm invisible" data-bs-toggle="offcanvas" href="#offcanvasExample" style="font-size: larger"></button>
                </div>
            </div>
                    ...
                    <asp:GridView ID="dgv_GP12_Historico" runat="server" AutoGenerateColumns="false" CssClass="table table-responsive shadow p-3 rounded border-top-0" BorderColor="black" Width="100%" OnRowCommand="GridViewCommandEventHandler" OnRowDataBound="GridView_DataBoundHist">
                        ...
                        <Columns>
                            <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="3%" Visible="true" ItemStyle-BackColor="#e6e6e6">
                                <ItemTemplate>
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <asp:LinkButton runat="server" ID="MoverScrap" UseSubmitBehavior="true" CommandName="MoverScrap" CommandArgument='<%#Eval("ID")%>' CssClass="btn btn-lg btn-success mt-1 shadow-lg" Style="font-size: 1rem">
                                          <i class="bi bi-recycle"></i></asp:LinkButton>
                                        <asp:LinkButton runat="server" ID="BorrarScrap" UseSubmitBehavior="true" CommandName="BorrarScrap" CommandArgument='<%#Eval("ID")%>' CssClass="btn btn-lg btn-danger mt-1 shadow-lg" Style="font-size: 1rem">
                                          <i class="bi bi-eraser"></i></asp:LinkButton>
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Lote / Revisión" ItemStyle-Width="7%" ItemStyle-HorizontalAlign="Center" ItemStyle-BackColor="#e6e6e6">
                                ...
                                <FooterTemplate>
                                    <asp:Label ID="placeholdertexto" runat="server" Text='Resultados:' />
                                </FooterTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField ItemStyle-Width="7%" ItemStyle-HorizontalAlign="Center" ItemStyle-BackColor="#e6e6e6" Visible="false">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton runat="server" ID="Muestrapop" CommandName="CargaDetalle" CommandArgument='<%#Eval("ID")%>' UseSubmitBehavior="true" CssClass="btn btn-lg btn-primary mt-1 shadow-lg" Style="font-size: 1rem">
