<%@ Page Title="" Language="C#" MasterPageFile="~/SMARTHLite.Master" AutoEventWireup="true" CodeBehind="IndiceMaterialesLITE.aspx.cs" Inherits="ThermoWeb.LOGISTICA.IndiceMaterialesLITE" %>
...
<asp:Content ID="Cuerpo" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        ...
        <div class="row row-cols-1 g-4 mt-1 mb-2">
            <div class="col-1"></div>
            <div class="col-4">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasMateriales" aria-labelledby="offcanvasRightLabel">
        ...
        <div class="offcanvas-body">
            ...
            <div class="card">
                ...
                <asp:GridView ID="GridUbicacion" runat="server" AllowSorting="True" Style="width: 100%" CssClass="table" AutoGenerateColumns="false" ShowHeader="false" EmptyDataText="Material sin ubicación definida">
                            ...
                            <asp:TemplateField ItemStyle-Width="50%" ItemStyle-HorizontalAlign="Left" ItemStyle-Font-Size="Large">
                                <ItemTemplate>
                                    ...
                                    <div class="input-group">
                                        <Label>&nbsp</Label>
                                        <asp:Label CssClass="btn btn-sm btn-dark" ID="Label1" BackColor="Black" ForeColor="White" Font-Bold="true" runat="server" Text='<%#Eval("Estanteria") %>' />
                                        ...
                                        <asp:Label CssClass="btn btn-sm btn-dark" ID="Label2" BackColor="Black" ForeColor="White" Font-Bold="true" runat="server" Text='<%#Eval("Modulo") %>' />
                                        <Label style="padding-top:7px; font-weight:bold" CssClass="btn btn-sm btn-dark me-1"  BackColor="Black" ForeColor="White" Font-Bold="true">&nbsp.&nbsp</Label>
                                        <asp:Label CssClass="btn btn-sm btn-dark" ID="Label3" BackColor="Black" ForeColor="White" Font-Bold="true" runat="server" Text='<%#Eval("Balda") %>' />
                                        <Label>&nbsp</Label>
                                    </div>
