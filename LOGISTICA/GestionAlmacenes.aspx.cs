...
namespace ThermoWeb.LOGISTICA
{
    public partial class UbicacionMateriales : System.Web.UI.Page
    {
        ...
        public void AgregarMaterialXUbicacion(object sender, EventArgs e)
        {
            ...
            Conexion_SMARTH conexion = new Conexion_SMARTH();
            conexion.Insertar_MaterialxUbicacion(AuxTBUbicacion.InnerText, MATERIAL, "0");
        ...
        public void GridCommandEventHandler(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "EliminaArticulo")
                {
                    ...
                    conexion.Elimina_MaterialxUbicacion(FECHA, ARTICULO, UBICACION);
                    Rellenar_Grid(null, null);
                    lkb_Sort_Click(estanteria);
        ...
        protected void lkb_Sort_Click(string e)
        {
            ...
            this.ManageTabsPostBack(TAB_EST_0, TAB_EST_1, TAB_EST_2, TAB_EST_3, TAB_EST_4, TAB_EST_5, TAB_EST_6, TAB_EST_7, TAB_EST_8, TAB_EST_9, TAB_EST_10, PILL_EST0, PILL_EST1, PILL_EST2, PILL_EST3, PILL_EST4, PILL_EST5, PILL_EST6, PILL_EST7, PILL_EST8, PILL_EST9, PILL_EST10, e);

        }

        private void ManageTabsPostBack(HtmlGenericControl TAB_EST_0, HtmlGenericControl TAB_EST_1, HtmlGenericControl TAB_EST_2, HtmlGenericControl TAB_EST_3, HtmlGenericControl TAB_EST_4, HtmlGenericControl TAB_EST_5, HtmlGenericControl TAB_EST_6, HtmlGenericControl TAB_EST_7, HtmlGenericControl TAB_EST_8, HtmlGenericControl TAB_EST_9, HtmlGenericControl TAB_EST_10, HtmlButton PILL_EST0, HtmlButton PILL_EST1, HtmlButton PILL_EST2, HtmlButton PILL_EST3, HtmlButton PILL_EST4, HtmlButton PILL_EST5, HtmlButton PILL_EST6, HtmlButton PILL_EST7, HtmlButton PILL_EST8, HtmlButton PILL_EST9, HtmlButton PILL_EST10, string grid)
        {
        ...
        public async Task<List<Inventario>> ObtenerInventarioAsync()
        {
            ...
            {
                string url = "http://tuapi.com/api/inventario";
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    return JsonConvert.DeserializeObject<List<Inventario>>(data);
                }
                return null;
            }
        }
