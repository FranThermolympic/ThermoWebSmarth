<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="GP12Historico.aspx.cs" Inherits="ThermoWeb.GP12.GP12Historico" MasterPageFile="~/SMARTH.Master"
            ...
            <div class="col-lg-12">
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills_historico" runat="server" role="tabpanel" aria-labelledby="pills-home-tab">
                        <asp:GridView ID="dgv_GP12_Historico" runat="server" AutoGenerateColumns="false" CssClass="table table-responsive shadow p-3 rounded border-top-0" BorderColor="black" Width="100%" OnRowCommand="GridViewCommandEventHandler" OnRowDataBound="GridView_DataBoundHist">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Lote / Revisión" ItemStyle-Width="7%" ItemStyle-HorizontalAlign="Center" ItemStyle-BackColor="#e6e6e6">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField ItemStyle-Width="7%" ItemStyle-HorizontalAlign="Center" ItemStyle-BackColor="#e6e6e6">
                                    <ItemTemplate>
                                        <asp:Label ID="lblHoras" runat="server" Font-Size="Larger" Text='<%#Eval("DoubleHoras", "{0:0.00 h}") %>' /><br />
                                        <asp:Label ID="lblPiezasrev" Font-Size="small" runat="server" Text='<%#"para " + Eval("PiezasRevisadas" ) + " piezas" %>' />
                                    </ItemTemplate>
                                    <FooterTemplate>
                                ...
                                <asp:TemplateField ItemStyle-Width="7%" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:Label ID="lblCliente" runat="server" Text='<%#Eval("Cliente") %>' Visible="false" />
                                ...
                                <asp:TemplateField HeaderText="Referencia" ItemStyle-Width="25%">
                                    <ItemTemplate>
                                        ...
                                        <asp:Label ID="lblMolde" Font-Bold="true" Font-Italic="true" runat="server" Text='<%#" (" + Eval("Molde") + ")" %>' /><br />
                                        <asp:Label ID="lblDescripcion" runat="server" Text='<%#Eval("Nombre") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Buenas" ItemStyle-Width="5%" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle">
                                    <ItemTemplate>
                                        <asp:Label ID="lblBuenas" runat="server" Font-Size="X-Large" Text='<%#Eval("PiezasOK") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Retrabajadas" ItemStyle-Width="5%" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle">
                                    <ItemTemplate>
                                        <asp:Label ID="lblRetrabajadas" runat="server" Font-Size="X-Large" Text='<%#Eval("Retrabajadas") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Malas" ItemStyle-Width="5%" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle">
                                    <ItemTemplate>
                                        <asp:Label ID="lblMalas" runat="server" Font-Size="X-Large" Text='<%#Eval("PiezasNOK") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Observaciones" ItemStyle-Width="41%">
                                    <ItemTemplate>
                                        <asp:Label ID="lblRazonRevision" runat="server" Font-Bold="true" Text='<%#Eval("Razon") %>' /><br />
                                        <asp:Label ID="lblObservaciones" runat="server" Text='<%#Eval("Incidencias") + "<br />" %>' Visible="false" />
                                        <asp:Label ID="lblNotas" runat="server" Text='<%#Eval("Notas") %>' Visible="false" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                    ...
                    <div class="tab-pane fade" id="pills_estados" runat="server" role="tabpanel" aria-labelledby="pills-profile-tab">
                        <div class="row">
                            <div class="col-lg-1">
                                <div class="input-group mb-3">
                                    <button id="filtroEstado" runat="server" onserverclick="Rellenar_grid" type="button" class="btn btn-secondary" style="width: 100%; text-align: left">
                                        <i class="bi bi-search me-2"></i>Filtrar</button>
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-check form-switch ms-3 mb-3">
                                    <input class="form-check-input" type="checkbox" runat="server" id="CheckEnRevision" checked>
                                    <label class="form-check-label" for="SwitchActivas">Mostrar sólo en revisión</label>
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-check form-switch ms-3 mb-3">
                                    <input class="form-check-input" type="checkbox" runat="server" id="CheckVencidas">
                        ...
                        <asp:GridView ID="dgv_EstadoReferencias" runat="server" BorderColor="black" Width="100%" CssClass="table table-responsive shadow p-3 rounded border-top-0" AutoGenerateColumns="false"
                            OnRowCancelingEdit="gridView_RowCancelingEdit" OnRowEditing="GridView_RowEditing" OnRowUpdating="GridView_RowUpdating" OnRowDataBound="GridView_RowDataBound" OnRowCommand="GridViewCommandEventHandler"
                            EmptyDataText="There are no data records to display.">
                            <HeaderStyle CssClass="card-header" BackColor="#0d6efd" Font-Bold="True" ForeColor="White" HorizontalAlign="Center" Height="40px" />
                            <RowStyle BackColor="White" />
                            <AlternatingRowStyle BackColor="#eeeeee" />
                            <EditRowStyle BackColor="#F6F0B5" />
                            <Columns>
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="3%" ItemStyle-BackColor="#e6e6e6">
                                    <ItemTemplate>
                                        <%--Botones de eliminar y editar cliente...--%>
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <asp:LinkButton runat="server" ID="btnEdit" CommandName="Edit" CssClass="btn btn-lg btn-primary mt-1 shadow-lg border border-1 border-dark" Style="font-size: 1rem">
                                          <i class="bi bi-pencil-fill"></i></asp:LinkButton>
                                            <asp:LinkButton ID="btnDetail" runat="server" CommandName="Redirect" CssClass="btn btn-lg btn-outline-dark mt-1 shadow-lg" CommandArgument='<%#Eval("REF")%>'><i class="bi-zoom-in"></i></asp:LinkButton>
                                        </div>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                ...
                                <asp:TemplateField ItemStyle-Width="7%" ItemStyle-HorizontalAlign="Center">
                                    ...
                                    <EditItemTemplate>
                                        <asp:Image ID="IMGlienteedit" runat="server" Width="59px" src='<%#Eval("LogotipoSM") %>' />
                                    </EditItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Referencia" ItemStyle-Width="25%">
                                    <ItemTemplate>
                                        <asp:Label ID="Label1" runat="server" Font-Size="Large" Font-Bold="true" Text='<%#Eval("REF") %>' />
                                        <asp:Label ID="lblMolde" Font-Bold="true" Font-Italic="true" runat="server" Text='<%#" (" + Eval("Molde") + ")" %>' /><br />
                                ...
                                <asp:TemplateField HeaderText="Estado" ItemStyle-Width="15%">
                                    <ItemTemplate>
                                        <asp:Label ID="lblEstadoActual" Font-Bold="true" runat="server" Text='<%#Eval("EstadoActual") %>' /><br />
                                        <asp:Label ID="lblFecharev" runat="server" Font-Italic="true" Font-Size="Small" Text='<%#"desde el " + Eval("Fecharev", "{0:dd/MM/yyyy}") + "." %>' />
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <asp:DropDownList ID="txtEstadoActual" runat="server" />
                                    </EditItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Responsable" ItemStyle-Width="7%">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField ItemStyle-Width="15%">
                                    <HeaderTemplate>
                                        ...
                                        <label>&nbsp Fecha prevista de salida</label>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lblFechaprevsalida" runat="server" Text='<%#"<strong>Salida prevista:</strong> " + Eval("Fechaprevsalida", "{0:dd/MM/yyyy}") %>' /><br />
                                        <asp:Label ID="lblFechaPrevVencidatxt" runat="server" Text='<%#Eval("Fechaprevsalida", "{0:dd/MM/yyyy}") %>' Visible="false" />

                                        <asp:Label ID="lblFechaVencida" runat="server" Font-Bold="true" Font-Size="Small" ForeColor="Red" Visible="false"><i class="bi bi-exclamation-circle-fill"> ¡Plazo vencido!</i><br /></asp:Label>
                                        <asp:Label ID="lblFechaProxima" runat="server" Font-Bold="true" Font-Size="Small" ForeColor="orange" Visible="false"><i class="bi bi-exclamation-triangle-fill"></i> El plazo vencerá pronto.</i><br /></asp:Label>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <label style="font-weight: 700">Salida prevista:</label><asp:TextBox ID="txtFechaprevsalida" runat="server" CssClass="textbox ms-2 Add-text" Width="120px" autocomplete="off" Text='<%#Eval("Fechaprevsalida", "{0:dd/MM/yyyy}") %>' />
                                ...
                                <asp:TemplateField HeaderText="Observaciones">
                                    <ItemTemplate>
                                        <asp:TextBox ID="lblObservaciones" runat="server" Width="100%" Text='<%#Eval("Observaciones") %>' Enabled="false" TextMode="MultiLine" BorderStyle="None" BackColor="Transparent" />
                                    </ItemTemplate>
                                    <EditItemTemplate>
