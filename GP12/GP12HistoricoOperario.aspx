<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="GP12HistoricoOperario.aspx.cs" Inherits="ThermoWeb.GP12.GP12HistoricoOperario"
        ...
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table width="100%">
                                <tr>
                                    <td colspan="2">
                                        <asp:TextBox ID="tbTituloOperario" Width="100%" runat="server" Style="text-align: center" Enabled="false">Operario</asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                        <asp:TextBox ID="tbNumOperario" Width="100%" runat="server" Style="text-align: center" Enabled="false"></asp:TextBox>
                                    </th>
                                    <td>
                                        <asp:TextBox ID="tbNombreOperario" Width="100%" runat="server" Style="text-align: center" Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                ...
                <div class="col-lg-1 text-right">
                    <label for="usr">Núm. operario:</label>
                    <asp:TextBox ID="selectoperario" runat="server" CssClass="textbox" Width="100%" Height="35px" autocomplete="off" />
                </div>
                        ...
                        <asp:GridView ID="dgv_AreaRechazo" runat="server" AllowSorting="True"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Refer.">
                                    <ItemTemplate>
                                        <asp:Label ID="lblLote" runat="server" Text='<%#Eval("Referencia") %>' />
                                    </ItemTemplate>
                                    <FooterTemplate>
                                ...
                                <asp:TemplateField HeaderText="Incidencias" ItemStyle-Width="120px" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblInci" runat="server" Text='<%#Eval("Incidencias") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Observa" ItemStyle-Width="120px" Visible="false">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Rayas/Expul." ItemStyle-Width="120px">
                                    <ItemTemplate>
