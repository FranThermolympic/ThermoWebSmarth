...
{
    public partial class GP12HistoricoCliente : System.Web.UI.Page
    {
        ...
        private void rellenar_grid()
        {
            try
            {
                ...
                dgv_AreaRechazo.Columns[2].FooterText = totalBuenas.ToString();
                MuroRevisadas.Text = totalBuenas.ToString();
                /*
                double totalHoras = 0;
                foreach (DataRow dr in ds_Referencias.Tables[0].Rows)
                {
                    totalHoras += Convert.ToDouble(dr["HORAS"]);
                }
                ...
                */
                ...
                dgv_AreaRechazo.Columns[3].FooterText = totalRetrabajadas.ToString();
                ...
                dgv_AreaRechazo.Columns[4].FooterText = totalMalas.ToString();
                ...
                dgv_AreaRechazo.Columns[6].FooterText = totalchatarra.ToString("C");
                ...
                dgv_AreaRechazo.Columns[7].FooterText = totalpersrevision.ToString("C");
                ...
                dgv_AreaRechazo.Columns[8].FooterText = totalrevision.ToString("C");
                ...
                dgv_AreaRechazo.Columns[9].FooterText = Defecto1.ToString();
                ...
                dgv_AreaRechazo.Columns[10].FooterText = Defecto2.ToString();
                ...
                dgv_AreaRechazo.Columns[11].FooterText = Defecto3.ToString();
                ...
                dgv_AreaRechazo.Columns[12].FooterText = Defecto4.ToString();
                ...
                dgv_AreaRechazo.Columns[13].FooterText = Defecto5.ToString();
                ...
                dgv_AreaRechazo.Columns[14].FooterText = Defecto6.ToString();
                ...
                dgv_AreaRechazo.Columns[15].FooterText = Defecto7.ToString();
                ...
                dgv_AreaRechazo.Columns[16].FooterText = Defecto8.ToString();
                ...
                dgv_AreaRechazo.Columns[17].FooterText = Defecto9.ToString();
                ...
                dgv_AreaRechazo.Columns[18].FooterText = Defecto10.ToString();
                ...
                dgv_AreaRechazo.Columns[19].FooterText = Defecto11.ToString();
                ...
                dgv_AreaRechazo.Columns[20].FooterText = Defecto12.ToString();
                ...
                dgv_AreaRechazo.Columns[21].FooterText = Defecto13.ToString();
                ...
                dgv_AreaRechazo.Columns[22].FooterText = Defecto14.ToString();
                ...
                dgv_AreaRechazo.Columns[23].FooterText = Defecto15.ToString();
                ...
                dgv_AreaRechazo.Columns[24].FooterText = Defecto16.ToString();
                ...
                dgv_AreaRechazo.Columns[25].FooterText = Defecto17.ToString();
                ...
                dgv_AreaRechazo.Columns[26].FooterText = Defecto18.ToString();
                ...
                dgv_AreaRechazo.Columns[27].FooterText = Defecto19.ToString();
                ...
                dgv_AreaRechazo.Columns[28].FooterText = Defecto20.ToString();
                ...
                dgv_AreaRechazo.Columns[29].FooterText = Defecto21.ToString();
                ...
                dgv_AreaRechazo.Columns[30].FooterText = Defecto22.ToString();
                ...
                dgv_AreaRechazo.Columns[31].FooterText = Defecto23.ToString();
                ...
                dgv_AreaRechazo.Columns[32].FooterText = Defecto24.ToString();
                ...
                dgv_AreaRechazo.Columns[33].FooterText = Defecto25.ToString();
                ...
                dgv_AreaRechazo.Columns[34].FooterText = Defecto26.ToString();
                ...
                dgv_AreaRechazo.Columns[35].FooterText = Defecto27.ToString();
                ...
                dgv_AreaRechazo.Columns[36].FooterText = Defecto28.ToString();
                ...
                dgv_AreaRechazo.Columns[37].FooterText = Defecto29.ToString();
                ...
                dgv_AreaRechazo.Columns[38].FooterText = Defecto30.ToString();
        ...
        protected void cargar_Filtrados(object sender, EventArgs e)
        {
            try
            {
                ...
                if (estado == "-") { estado = ""; }
                string cliente = "";
                if (lista_clientes.SelectedValue != "-")
                { 
                    cliente = lista_clientes.SelectedValue;
                }
                 
                    ds_Referencias = conexion.devuelve_detalle_revisiones_referencia_filtradasSMARTH(Convert.ToString(selectReferencia.Text), selectLote.Text, estado, selectFecha.Text, cliente, selectMolde.Text);
            ...
            try {
                for (int i = 0; i <= dgv_AreaRechazo.Rows.Count - 1; i++)
                {
                    ...
                    Label lblparent32 = (Label)dgv_AreaRechazo.Rows[i].FindControl("lblDefecto30");
                        ...
                        if (lblparent.Text != "0")
                        {
                            dgv_AreaRechazo.Rows[i].Cells[4].BackColor = System.Drawing.Color.Red;
                            lblparent.ForeColor = System.Drawing.Color.White;
                        }

                        if (lblparent2.Text != "0")
                        {
                            dgv_AreaRechazo.Rows[i].Cells[3].BackColor = System.Drawing.Color.Yellow;
                        ...
                        {
                            dgv_AreaRechazo.Rows[i].Cells[10].BackColor = System.Drawing.Color.Red;
                            lblparent4.ForeColor = System.Drawing.Color.White;
                        }

                        if (lblparent5.Text != "0")
                        {
                            dgv_AreaRechazo.Rows[i].Cells[11].BackColor = System.Drawing.Color.Red;
                            lblparent5.ForeColor = System.Drawing.Color.White;
                        }

                        if (lblparent6.Text != "0")
                        {
                            dgv_AreaRechazo.Rows[i].Cells[12].BackColor = System.Drawing.Color.Red;
                            lblparent6.ForeColor = System.Drawing.Color.White;
                        }

                        if (lblparent7.Text != "0")
                        {
                            dgv_AreaRechazo.Rows[i].Cells[13].BackColor = System.Drawing.Color.Red;
