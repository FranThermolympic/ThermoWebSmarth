<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="GP12HistoricoReferenciaLite.aspx.cs" Inherits="ThermoWeb.GP12.GP12HistoricoReferenciaLite" MasterPageFile="~/SMARTHLite.Master"
...
<asp:Content ID="Cuerpo" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
     ...
     <asp:GridView ID="dgv_GP12_Historico" runat="server" AllowSorting="True" Width="100%" ShowFooter="true" AutoGenerateColumns="false" CssClass="table table-responsive shadow p-3 rounded border-top-1"
                    OnRowCommand="GridViewCommandEventHandler" OnRowDataBound="GridView1_DataBound" EmptyDataText="No hay revisiones para mostrar.">
                    <HeaderStyle CssClass="card-header border-1 border-dark" BackColor="lightgrey" Font-Bold="True" ForeColor="black" HorizontalAlign="Center" Height="40px" />
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Tubo: Posición" ItemStyle-Width="120px">
                            <ItemTemplate>
        ...
        <div class="row" hidden="hidden">
            <div class="col-lg-4 mt-4">
                <div class="row">
                    ...
                    <div class="col-lg-8 px-0 ms-2">
                        <asp:Label ID="tbReferenciaCarga" Width="100%" runat="server" Style="text-align: center" Enabled="false" Visible="false"></asp:Label>
                        <label id="tbMoldeReferencia" class="ms-2" runat="server" style="text-align: left; font-size: x-large; font-weight: bold" enabled="false"></label><br />                      
                        <asp:label id="tbDescripcionCarga" class="ms-2" runat="server" Font-Italic="true" style="text-align: left" /><br />
                        <asp:label id="tbEstadoReferencia" class="ms-2" runat="server" Font-Bold="true" Font-Italic="true" style="text-align: left" />
                    </div>
                </div>
            </div>
            <div class="col-lg-8 mt-4 ">
                <div class="row ">
                    <div class="col-lg-1"></div>
                    <div class="col-lg-2 px-0">
                        <asp:TextBox ID="CabeceraBlanco" Width="100%" runat="server" Style="text-align: center; background-color: transparent; border-color: transparent; border: thin" Enabled="false"></asp:TextBox><br />
                        <asp:TextBox ID="LineaMaquina" Width="100%" runat="server" Font-Bold="true" Style="text-align: center; background-color: #ccccff" Enabled="false">Producción</asp:TextBox><br />
                        <asp:TextBox ID="LineaMuro" Width="100%" runat="server" Font-Bold="true" Style="text-align: center; background-color: #ccccff" Enabled="false">GP12</asp:TextBox>
                    </div>
                    <div class="col-lg-1 px-0">
                        <asp:TextBox ID="CabeceraProdRev" runat="server" Width="100%" ForeColor="White" Font-Bold="true" Style="text-align: center; background-color: #337ab7; border-color: orange; border: thin" Enabled="false">Buenas</asp:TextBox><br />
                        <asp:TextBox ID="MaquinaFabricadas" runat="server" Width="100%" Style="text-align: center" Enabled="false"></asp:TextBox><br />
                        <asp:TextBox ID="MuroRevisadas" runat="server" Width="100%" Style="text-align: center" Enabled="false"></asp:TextBox>
                    </div>
                    <div class="col-lg-1 px-0">
                        <asp:TextBox ID="CabeceraRechazas" runat="server" Width="100%" ForeColor="White" Font-Bold="true" Style="text-align: center; background-color: #337ab7; border-color: orange; border: thin" Enabled="false">Rechazadas</asp:TextBox><br />
                        <asp:TextBox ID="MaquinaRechazadas" runat="server" Width="100%" Style="text-align: center" Enabled="false"></asp:TextBox><br />
                        <asp:TextBox ID="MuroRechazadas" runat="server" Width="100%" Style="text-align: center" Enabled="false"></asp:TextBox>
                    </div>
                    <div class="col-lg-1 px-0">
                        <asp:TextBox ID="CabeceraRecuperadas" runat="server" Width="100%" ForeColor="White" Font-Bold="true" Style="text-align: center; background-color: #337ab7; border-color: orange; border: thin" Enabled="false">Recuperadas</asp:TextBox><br />
                        <asp:TextBox ID="MaquinaRecuperadas" runat="server" Width="100%" Style="text-align: center" Enabled="false"></asp:TextBox><br />
                        <asp:TextBox ID="MuroRecuperadas" runat="server" Width="100%" Style="text-align: center" Enabled="false"></asp:TextBox>
                    </div>
                    <div class="col-lg-1 px-0">
                        <asp:TextBox ID="CabeceraHoras" runat="server" Width="100%" ForeColor="White" Font-Bold="true" Style="text-align: center; background-color: #337ab7; border-color: orange; border: thin" Enabled="false">Tiempo (H)</asp:TextBox><br />
                        <asp:TextBox ID="MaquinaHoras" runat="server" Width="100%" Style="text-align: center" Enabled="false"></asp:TextBox><br />
                        <asp:TextBox ID="MuroHoras" runat="server" Width="100%" Style="text-align: center" Enabled="false"></asp:TextBox>
                    </div>
                    <div class="col-lg-1 px-0">
                        <asp:TextBox ID="CabeceraCiclo" runat="server" Width="100%" ForeColor="White" Font-Bold="true" Style="text-align: center; background-color: #337ab7; border-color: orange; border: thin" Enabled="false">Piezas/hora</asp:TextBox><br />
                        <asp:TextBox ID="MaquinaCiclo" runat="server" Width="100%" Style="text-align: center" Enabled="false"></asp:TextBox><br />
                        <asp:TextBox ID="MuroCiclo" runat="server" Width="100%" Style="text-align: center" Enabled="false"></asp:TextBox>
                    </div>
                    <div class="col-lg-1 px-0">
                        <asp:TextBox ID="CabeceraScrap" runat="server" Width="100%" ForeColor="White" Font-Bold="true" Style="text-align: center; background-color: #337ab7; border-color: orange; border: thin" Enabled="false">Scrap (€)</asp:TextBox><br />
                        <asp:TextBox ID="MaquinaScrap" runat="server" Width="100%" Style="text-align: center" Enabled="false"></asp:TextBox><br />
                        <asp:TextBox ID="MuroScrap" runat="server" Width="100%" Style="text-align: center" Enabled="false"></asp:TextBox>
                    </div>
                    <div class="col-lg-1 px-0">
                        <asp:TextBox ID="CabeceraInspeccion" runat="server" Width="100%" ForeColor="White" Font-Bold="true" Style="text-align: center; background-color: #337ab7; border-color: orange; border: thin" Enabled="false">Inspector (€)</asp:TextBox><br />
                        <asp:TextBox ID="MaquinaInspeccion" runat="server" Width="100%" Style="text-align: center" Enabled="false"></asp:TextBox><br />
                        <asp:TextBox ID="MuroInspeccion" runat="server" Width="100%" Style="text-align: center" Enabled="false"></asp:TextBox>
                    </div>
                    <div class="col-lg-1 px-0">
                        <asp:TextBox ID="CabeceraMuro" runat="server" Width="100%" ForeColor="White" Font-Bold="true" Style="text-align: center; background-color: #337ab7; border-color: orange; border: thin" Enabled="false">Total (€)</asp:TextBox><br />
                        <asp:TextBox ID="MaquinaTotal" runat="server" Width="100%" Style="text-align: center" Enabled="false"></asp:TextBox><br />
