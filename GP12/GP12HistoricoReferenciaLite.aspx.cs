...
{
    public partial class GP12HistoricoReferenciaLite : System.Web.UI.Page
    {
        ...
        public void Rellenar_grid(object sender, EventArgs e)
        {
            try
            {
                ...
                ds_Muro_Calidad = SHconexion.Devuelve_ultimas_revisiones_periodo(Convert.ToInt32(Selecaño.SelectedValue), " ", referencia, molde, lote, cliente, responsable, fechainicio, fechafin, defectuosas,"");
                ...
                tbReferenciaCarga.Text = ds_Muro_Calidad.Rows[0]["Referencia"].ToString();
                tbMoldeReferencia.InnerText = ds_Muro_Calidad.Rows[0]["Referencia"].ToString() + " (" + ds_Muro_Calidad.Rows[0]["Molde"].ToString() + ")";
                tbDescripcionCarga.Text = ds_Muro_Calidad.Rows[0]["Nombre"].ToString();
                ...
                DataTable EstadoREF = SHconexion.Devuelve_Estado_Referencias("AND P.[Referencia] = " + tbReferenciaCarga.Text, "", "", "", "", "");
                tbEstadoReferencia.Text = EstadoREF.Rows[0]["EstadoActual"].ToString();
                IMGliente.ImageUrl = EstadoREF.Rows[0]["LogotipoSM"].ToString();
                ...
                double FrecuenciaMuro = (totalBuenas + totalMalas + totalRetrabajadas) / totalHoras;
                MuroCiclo.Text = Convert.ToInt32(FrecuenciaMuro).ToString();
