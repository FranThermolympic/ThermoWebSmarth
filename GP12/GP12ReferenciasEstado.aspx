<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="GP12ReferenciasEstado.aspx.cs" Inherits="ThermoWeb.GP12.GP12ReferenciasEstado" MasterPageFile="~/SMARTH.Master"
    MaintainScrollPositionOnPostback="true" %>


<asp:Content ID="Cabecera" ContentPlaceHolderID="HeadContent" runat="server">
    <title>Estado de revisión de las referencias</title>
    <link rel="shortcut icon" type="image/x-icon" href="ICONOS/FAVICON.ico" />
</asp:Content>
<asp:Content ID="NavbarAPP" ContentPlaceHolderID="NavbarAPP" runat="server">
    &nbsp- Estado de revisión             
</asp:Content>
    ...
    <div class="container-fluid" style="background: url(LOGOFONDOTHERMO.png) right top no-repeat">
        <div class="row">
            ...
            <div class="col-lg-1 text-center">
                <label class="ms-1" style="font-size: larger; font-weight: bold">En revisión</label><br />
                <asp:Label ID="lblEnRevision" Font-Size="X-Large" runat="server">0</asp:Label>
            </div>
            <div class="col-lg-1 text-center ">
                <label style="font-size: larger; font-weight: bold">Vencidas</label><br />
                <asp:Label ID="lblVencidas" Font-Size="X-Large" runat="server">0</asp:Label><br />
                <asp:Label ID="lblVencidasPORC" Font-Size="Smaller" runat="server" Font-Italic="true">0% vencidas.</asp:Label>
            </div>
            <div class="col-lg-1 text-center ">
                <label class="ms-1" style="font-size: larger; font-weight: bold">En plazo</label><br />
                <asp:Label ID="lblEnPlazo" Font-Size="X-Large" runat="server">0</asp:Label><br />
                <asp:Label ID="lblEnPlazoPORC" Font-Size="Smaller" runat="server" Font-Italic="true" CssClass="ms-3">0% en plazo.</asp:Label>
            </div>
            <div class="col-lg-1 mt-1 ">
                <div class="d-grid gap-2 d-md-flex justify-content-md-end  me-md-4 ">
                    ...
                    <button id="btnoffcanvas" runat="server" type="button" class="btn btn-primary ms-md-0 bi bi-funnel shadow-sm mt-2" data-bs-toggle="offcanvas" href="#offcanvasExample" style="font-size: larger"></button>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="col-lg-12">
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills_estados" runat="server" role="tabpanel" aria-labelledby="pills-profile-tab">
                        <asp:GridView ID="dgv_EstadoReferencias" runat="server" BorderColor="black" Width="100%" CssClass="table table-responsive shadow p-3 rounded border-top-0 mt-2" AutoGenerateColumns="false"
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
            ...
            <div class="offcanvas-body">
                <div class="row">
                    ...
                    <div class="form-check form-switch ms-3  mt-3 mb-3">
