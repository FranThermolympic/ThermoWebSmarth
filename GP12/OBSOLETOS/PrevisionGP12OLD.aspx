<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrevisionGP12OLD.aspx.cs" Inherits="ThermoWeb.GP12.GP12PrevisionGP12"
                        ...
                        <div class="table-responsive">
                            <asp:GridView ID="dgv_atrasados" runat="server" AllowSorting="True" margin="20px" Style="margin-left: 1%;"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="A enviar" ItemStyle-Width="100px">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCantidad" runat="server" Text='<%#Eval("cantidad") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Existencias" ItemStyle-Width="100px">
                                        <ItemTemplate>
                                            <asp:Label ID="lblDisponible" runat="server" Text='<%#Eval("almacengral") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="En GP12" ItemStyle-Width="100px" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblGP12" runat="server" Text='<%#Eval("gp12") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Cliente" ItemStyle-Width="250px">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCliente" runat="server" Text='<%#Eval("planta") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
