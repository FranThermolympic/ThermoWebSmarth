    ...
    <div class="row">
        ...
        <asp:GridView ID="dgv_KPI_Mensual" runat="server" AllowSorting="True" margin="20px" Style="margin-left: 1%;"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="% Revisadas"  ItemStyle-BackColor="#EFEFEF"  ItemStyle-Font-Bold="true">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="% Retrabajadas" ItemStyle-BackColor="#EFEFEF"  ItemStyle-Font-Bold="true">
                    <ItemTemplate>
    ...
    <div class="row">
        ...
        <asp:GridView ID="dgv_KPI_Operarios" runat="server" AllowSorting="True" margin="20px" Style="margin-left: 1%;"
            ...
            <Columns>
                ...
                <ItemTemplate>
                       <asp:Button ID = "btnDetailOP1" runat = "server" CommandName="Redirect2" class="btn btn-info btn-xs" CommandArgument='<%#Eval("IDE")%>' Text="+" />
                </ItemTemplate>
                </asp:TemplateField>
    ...
    <div class="row">
        ...
        <asp:GridView ID="TopDeteccionesAño" runat="server" AllowSorting="True" margin="20px" Style="margin-left: 1%;"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText=""   ItemStyle-BackColor="#ccccff">
                <ItemTemplate>
                       <asp:Button ID = "btnDetail1" runat = "server" CommandName="Redirect2" class="btn btn-info btn-xs" CommandArgument='<%#Eval("IDE")%>' Text="+" />
                </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Operario">
                    <ItemTemplate>
