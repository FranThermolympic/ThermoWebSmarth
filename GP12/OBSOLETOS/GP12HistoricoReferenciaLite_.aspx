<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="GP12HistoricoReferenciaLite_.aspx.cs" Inherits="ThermoWeb.GP12.GP12HistoricoReferenciaLite_" MasterPageFile="~/SMARTH.Master"
    EnableEventValidation="false" MaintainScrollPositionOnPostback="true" %>

<asp:Content ID="Cabecera" ContentPlaceHolderID="HeadContent" runat="server" Visible="false">
    <title>Histórico del muro de calidad</title>
    <link rel="shortcut icon" type="image/x-icon" href="ICONOS/FAVICON.ico" />
</asp:Content>
<asp:Content ID="NavbarAPP" ContentPlaceHolderID="NavbarAPP" runat="server" Visible="false">
    &nbsp- Histórico de referencia             
</asp:Content>
<asp:Content ID="NavbarACCESOS" ContentPlaceHolderID="NavbarACCESOS" runat="server" Visible="false">
    <ul class="navbar-nav me-auto mb-2 mb-lg-0" hidden="hidden">
