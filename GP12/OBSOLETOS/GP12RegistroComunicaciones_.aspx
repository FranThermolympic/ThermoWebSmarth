<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="GP12RegistroComunicaciones_.aspx.cs" Inherits="ThermoWeb.GP12.GP12RegistroComunicaciones"
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="col-lg-2">
                    ...
                    <asp:DropDownList ID="TablaSeleccion" runat="server" CssClass="form-control" Font-Size="Large"  AutoPostBack="True" OnSelectedIndexChanged="rellenar_grid">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 text-right">
                            <br />
                            <button id="Button2" runat="server" onserverclick="rellenar_grid" type="button" class="btn btn-lg btn-info" style="width: 75%; text-align: left">
        ...
        <div class="table-responsive">
            <asp:GridView ID="dgv_AreaRechazo" runat="server" AllowSorting="True" margin="20px" Style="margin-left: 1%;"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Operario" ItemStyle-Width="150px">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Lote" ItemStyle-BackColor="#e6e6e6">
                        <ItemTemplate>
                            <asp:Label ID="lblLote" runat="server" Font-Bold="true" Font-Size="Large" Text='<%#Eval("Nlote") %>' />
                    ...
                    <asp:TemplateField HeaderText="Notas revisión" ItemStyle-Width="30px" ItemStyle-BackColor="#e6e6e6">
                        <ItemTemplate>
                            <asp:Label ID="lblRevision" runat="server" Text='<%#Eval("Notas") %>' /><br />
                            <asp:Label ID="lblObservaciones" runat="server" Text='<%#Eval("Incidencias") %>' /><br />
                            <asp:Label ID="INFOOPOBSERV" runat="server" Text='<%#"<strong>Operario:</strong>:" + Eval("FeedbackOPERARIOS") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
