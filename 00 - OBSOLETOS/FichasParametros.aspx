<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="FichasParametros.aspx.cs"
    Inherits="ThermoWeb.FichasParametros" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" %>
                    ...
                    <div id="Div1" class="panel panel-default" runat="server">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form action="/action_page.php">
                                        <div class="form-group">
                                            <label for="usr">
                                                Referencia pieza:</label>
                                            <input id="tbFicha" runat="server" type="text" class="form-control" placeholder="Escribir referencia">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <label for="usr">
                                            Versión:</label>
                                        <asp:DropDownList ID="lista_versiones" runat="server" CssClass="form-control">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <%-- <div class="col-lg-1">
                                <div class="form-group">
                                    <button id="btnCargar" runat="server" type="button" onserverclick="cargarFicha" class="btn btn-primary">
                                        Cargar</button>
                                </div>
                            </div>--%>
                            </div>
                            <div class="row">
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        <button id="btnCargar" runat="server" type="button" onserverclick="CargarFicha" class="btn">
                                            Cargar</button>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        <div class="btn-group">
                            ...
                            <button id="btnModificar" runat="server" type="button" onserverclick="Modificar_ficha"
                                class="btn btn-primary">
                                Modificar ficha</button>
                            <button id="recalfull" runat="server" type="button" onserverclick="Recalcular_Limites"
                                class="btn btn-primary">
                                Guardar y recalcular</button>
                            <button id="btnGuardar" runat="server" onserverclick="GuardarFicha" type="button"
                                visible="false" class="btn btn-primary">
                                Guardar sin recalcular</button>
                            <button id="btnImprimir" runat="server" type="button" onserverclick="Imprimir_ficha"
                                class="btn btn-primary">
                                Descargar ficha</button>

                            <button id="btnCancelar" runat="server" onserverclick="CancelarModificacion" type="button"
                                visible="false" class="btn btn-primary">
                                Cancelar</button>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                                ...
                                <div class="table-responsive">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="tbFuerzaCierre" runat="server" Enabled="false" Style="text-align: center"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="tbManoRobot" runat="server" Style="text-align: center"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>
                    ...
                    <ul class="nav nav-pills nav-justified">
                        ...
                        <li><a data-toggle="pill" href="#ESTRUCTURA">Estructura</a></li>
                    ...
                    <div class="tab-content">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="table-responsive">
                                                                <table>
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="4">
                                                                            <button id="reclimTiempoInyeccion" runat="server" type="button" onserverclick="Recalcular_Limites" style="width: 100%" class="btn btn-primary btn-xs">Recalcular (±10%)</button>
                                                                        </td>
                                                                        <td colspan="4">
                                                                            <button id="reclimLimitePresion" runat="server" type="button" onserverclick="Recalcular_Limites" style="width: 100%" class="btn btn-primary btn-xs">Recalcular (±10%)</button>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </div>
                                                ...
                                                <div class="col-lg-8">
                                                    <div class="table-responsive">
                                                        <table>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:TextBox ID="thPresion" runat="server" Style="text-align: center" Enabled="false">Presión (bar)</asp:TextBox>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:TextBox ID="thTPtiempo" runat="server" Style="text-align: center" Enabled="false">Tiempo (s)</asp:TextBox>
                                                                </td>
                                                                <td>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="table-responsive">
                                                        <table>
                                                            ...
                                                            <tr>
                                                                <td colspan="4">
                                                                    <button id="reclimtbConmutacion" runat="server" type="button" onserverclick="Recalcular_Limites" style="width: 100%" class="btn btn-primary btn-xs">Recalcular (±10%)</button>
                                                                </td>
                                                                <td colspan="4">
                                                                    <button id="reclimtbTiempoPresion" runat="server" type="button" onserverclick="Recalcular_Limites" style="width: 100%" class="btn btn-primary btn-xs">Recalcular (±10%)</button>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                            ...
                                            <div id="Div12" class="table-editable">
                                                <div class="table-responsive">
                                                    <table id="Table1" runat="server">
                                                        ...
                                                        <tr>
                                                            <td colspan="4">
                                                                <button id="recalclimthVCarga" runat="server" type="button" onserverclick="Recalcular_Limites" style="width: 100%" class="btn btn-primary btn-xs">Recalcular (±10%)</button>
                                                            </td>
                                                            <td colspan="4">
                                                                <button id="recalclimthCarga" runat="server" type="button" onserverclick="Recalcular_Limites" style="width: 100%" class="btn btn-primary btn-xs">Recalcular (±10%)</button>
                                                            </td>
                                                            <td colspan="4">
                                                                <button id="recalclimthDescomp" runat="server" type="button" onserverclick="Recalcular_Limites" style="width: 100%" class="btn btn-primary btn-xs">Recalcular (±10%)</button>
                                                            </td>
                                                            <td colspan="4">
                                                                <button id="recalclimthContrapr" runat="server" type="button" onserverclick="Recalcular_Limites" style="width: 100%" class="btn btn-primary btn-xs">Recalcular (±10%)</button>
                                                            </td>
                                                            <td colspan="4">
                                                                <button id="recalclimthTiempo" runat="server" type="button" onserverclick="Recalcular_Limites" style="width: 100%" class="btn btn-primary btn-xs">Recalcular (±10%)</button>
                                                            </td>
                                                            <td colspan="4">
                                                                <button id="recalcthEnfriamiento" runat="server" type="button" onserverclick="Recalcular_Limites" style="width: 100%" class="btn btn-primary btn-xs">Recalcular (±10%)</button>
                                                            </td>
                                                            <td colspan="4">
                                                                <button id="recalclimthCiclo" runat="server" type="button" onserverclick="Recalcular_Limites" style="width: 100%" class="btn btn-primary btn-xs">Recalcular (±10%)</button>
                                                            </td>
                                                            <td colspan="4">
                                                                <button id="recalclimthCojin" runat="server" type="button" onserverclick="Recalcular_Limites" style="width: 100%" class="btn btn-primary btn-xs">Recalcular (±10%)</button>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                                                ...
                                                <div class="table-responsive">
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="MarcasOtrosText" runat="server" Style="text-align: center" Enabled="false" Height="50px" TextMode="MultiLine"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                        ...
                        <%-- Abro panel de estructura--%>
                        <div id="ESTRUCTURA" class="tab-pane fade">
                            <h3>Estructura y materias primas</h3>
                            <p>En esta sección podrás ver los materiales necesarios para la fabricación y sus características.</p>

                            <div class="row">
                                <div id="Div19" class="col-lg-12" runat="server">
                                    <div id="Div21" class="panel panel-default" runat="server">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">
                                                <i class="fa fa-list-ul fa-fw"></i>Materiales y estructura</h3>
                                        </div>
                                        <div class="panel-body">
                                            <div class="table-responsive">
                                                <table id="Estructura" runat="server" class="table table-bordered table-hover table-striped">
                                                </table>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <%-- Cierro panel de estructura--%>
                        </div>
                        <%-- Panel de histórico--%>
                        <div id="HISTORICO" class="tab-pane fade">
                            <h3>Histórico de modificaciones</h3>
                            <p>En esta tabla podrás ver el historial de modificaciones y las razones.</p>
                            <div class="row">
                                <div id="Div3" class="col-lg-12" runat="server">
                                    <div id="Div4" class="panel panel-default" runat="server">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">
                                                <i class="fa fa-list-ul fa-fw"></i>Histórico de modificaciones</h3>
                                        </div>
                                        <div class="panel-body">
                                            <div class="table-responsive">
                                                <table id="HistoricoModificaciones" runat="server" class="table table-bordered table-hover table-striped">
                                                </table>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <button id="botonvalidar" runat="server" onserverclick="Validar_ficha" type="button" style="width: 100%" class="btn btn-primary btn-xs">Validar por personal</button>
                                </div>
                            </div>
                        </div>
                    </div>
