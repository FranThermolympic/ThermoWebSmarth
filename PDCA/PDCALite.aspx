<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="PDCALite.aspx.cs" Inherits="ThermoWeb.PDCA.PlandeAccionesLite" MasterPageFile="~/SMARTHLite.Master"
...
<asp:Content ID="Cuerpo" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="overflow-y: auto;">
        <asp:GridView ID="dgvListadoPDCA" runat="server" AutoGenerateColumns="false" CssClass="table table-responsive shadow p-3 rounded border-top-1" DataKeyNames="IdPDCA" OnRowDataBound="OnRowDataBound" OnRowEditing="GridView_RowEditing_PDCA" OnRowCancelingEdit="gridView_RowCancelingEdit_PDCA" OnRowCommand="GridViewCommandEventHandler" BorderColor="black" Width="100%">
    ...
    <div class="row" hidden="hidden">
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
            ...
            <div class="offcanvas-body">
                ...
                <br />
                <%-- <h6>Piloto:</h6>--%>
                <select class="form-select" runat="server" visible="false" id="FiltroOperario">
                </select>
                <br />
                <h6>Ordenar por:</h6>
                <div class="input-group">
