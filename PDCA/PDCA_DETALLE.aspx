<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="PDCA_DETALLE.aspx.cs" Inherits="ThermoWeb.PDCA.PlandeAccionesDetalles" MasterPageFile="~/SMARTH.Master"
    EnableEventValidation="false" MaintainScrollPositionOnPostback="true" %>


<asp:Content ID="Cabecera" ContentPlaceHolderID="HeadContent" runat="server">
    <title>Detalles plan de acción</title>
    <link rel="shortcut icon" type="image/x-icon" href="ICONOS/FAVICON.ico" />
</asp:Content>
<asp:Content ID="NavbarAPP" ContentPlaceHolderID="NavbarAPP" runat="server">
    &nbsp- Detalle de plan de acción
...
<asp:Content ID="Cuerpo" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
                    ...
                    <div style="overflow-y: auto;">
                        ...
                        <asp:GridView ID="dgvListadoPDCA" runat="server" AutoGenerateColumns="false" CssClass="table table-responsive shadow-lg p-3 mb-5 rounded border-top-0" DataKeyNames="IdPDCA" OnRowDataBound="OnRowDataBound" OnRowEditing="GridView_RowEditing_PDCA" OnRowCancelingEdit="gridView_RowCancelingEdit_PDCA" OnRowCommand="GridViewCommandEventHandler" BorderColor="black" Width="100%">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField ItemStyle-Font-Bold="true" ItemStyle-HorizontalAlign="Center" HeaderText="Cerradas" ItemStyle-Width="5%">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Referencia / Proyecto" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="15%">
                                    <ItemTemplate>
                                        <asp:Label ID="lblReferencia" runat="server" Text='<%#Eval("Referencia") %>' /><br />
                                ...
                                <asp:TemplateField HeaderText="Cliente" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="7%">
                                    <ItemTemplate>
                                        <asp:Label ID="lblCliente" runat="server" Text='<%#Eval("Cliente") %>' />
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <asp:DropDownList ID="dropCliente" runat="server" CssClass="form-control">
                                            <asp:ListItem Selected="True" Value="0"> - </asp:ListItem>
                                        </asp:DropDownList>
                                    </EditItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField ItemStyle-Font-Bold="true" ItemStyle-HorizontalAlign="Center" HeaderText="Prioridad" ItemStyle-Width="5%">
                                    ...
                                    <EditItemTemplate>
                                        <asp:DropDownList ID="dropPrioridad" runat="server" CssClass="form-control">
                                ...
                                <asp:TemplateField HeaderText="Piloto" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="7%">
                                    ...
                                    <EditItemTemplate>
                                        <asp:DropDownList ID="dropPiloto" runat="server" CssClass="form-control">
                                ...
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Font-Bold="true" HeaderText="Estado" ItemStyle-Width="5%">
                                    ...
                                    <EditItemTemplate>
                                        <asp:DropDownList ID="dropEstado" runat="server" CssClass="form-control">
                                ...
                                <asp:TemplateField ItemStyle-Font-Bold="true" ItemStyle-Width="6%">
                                    <ItemTemplate>
                                        <asp:LinkButton runat="server" ID="btnEdit" CommandName="Edit" CssClass="btn btn-secondary me-md-3 float-end" Style="font-size: 1rem">
                                            <i class="bi bi-pencil-fill" aria-hidden="true"></i>
                                        </asp:LinkButton>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <div class="d-grid gap-2 d-md-block float-end">
                                            <asp:LinkButton runat="server" ID="btnCancelEdit" CommandName="Cancel" CssClass="btn btn-danger me-md-0 " Style="font-size: 1rem">
                                            <i class="bi bi-caret-left-fill" aria-hidden="true"></i>
                                            </asp:LinkButton>

                                            <asp:LinkButton runat="server" ID="btnGuardar" CommandName="Update" CssClass="btn btn-success me-md-3" Style="font-size: 1rem">
            ...
            <div class="col-lg-12">
                <div class="container-fluid mt-md-1">
                    <h3 runat="server" id="LBLNUMPDCA" visible="false">0</h3>
                    <h3 runat="server" id="LBLTITULOPDCA">Vinculado a GOP</h3>
                    <h6 runat="server" id="LBLTITULOPDCAACCIONES" class="ms-2">0</h6>
                    <div style="overflow-y: auto;">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body" runat="server">
                        ...
                        <br />
                        <label style="font-weight: 700">Añadir referencia:</label>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
            ...
            <div class="offcanvas-body">
                ...
                <br />
                <h6>Piloto:</h6>
                <select class="form-select" runat="server" id="FiltroOperario">
                </select>
                <br />
                <h6>Ordenar por:</h6>
                <div class="input-group">
