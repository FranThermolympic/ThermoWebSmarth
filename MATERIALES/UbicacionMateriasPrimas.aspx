<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="UbicacionMateriasPrimas.aspx.cs" Inherits="ThermoWeb.MATERIALES.UbicacionMateriales" MasterPageFile="~/SMARTH.Master"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField ItemStyle-Width="90%" ItemStyle-HorizontalAlign="Left" ItemStyle-Font-Size="Large">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:LinkButton runat="server" ID="BTNBloquearProduccion" UseSubmitBehavior="true" CssClass="btn  btn-primary border border-dark float-end shadow" CommandName="BloqueaArticulo" CommandArgument='<%#Eval("Fechaentrada","{0:dd/MM/yyyy}") + "¬" + Eval("Articulo") + "¬" + Eval("Ubicacion") + "¬" + Eval("EnMaquina") + "¬" + Eval("Lote") %>' Style="font-size: 1rem">
                                                ...
                                                <asp:TemplateField ItemStyle-Width="90%" ItemStyle-HorizontalAlign="Left" ItemStyle-Font-Size="Large">
                                                    <ItemTemplate>
                                                        <div class="btn-group me-2">
                                                            ...
                                                            <asp:LinkButton runat="server" ID="BTNBloquearProduccion" Visible="false" UseSubmitBehavior="true" CssClass="btn  btn-primary border border-dark shadow" Style="font-size: 1rem">
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField ItemStyle-Width="90%" ItemStyle-HorizontalAlign="Left" ItemStyle-Font-Size="Large">
                                                            ...
                                                            <i class="bi bi-x"></i>
                                                                    ...
                                                                    <asp:LinkButton runat="server" ID="BTNBloquearProduccion" CommandName="BloqueaArticulo" CommandArgument='<%#Eval("Fechaentrada","{0:dd/MM/yyyy}") + "¬" + Eval("Articulo") + "¬" + Eval("Ubicacion") + "¬" + Eval("EnMaquina") + "¬" + Eval("Lote") %>' UseSubmitBehavior="true" CssClass="btn  btn-primary border border-dark shadow" Style="font-size: 1rem">
                                                                        <i class="bi bi-gear-wide-connected"></i>
                                                                    </asp:LinkButton>
                                                                </div>
                                                                <asp:Label ID="lblArticuloText" Font-Italic="true" Font-Bold="true" runat="server" Text='<%#Eval("Articulo") + " " + Eval("Descripcion")  %>' />
                                            ...
                                            <div class="col-lg-3 border border-dark p-0" runat="server" id="COL_E3">
                                                ...
                                                <asp:GridView ID="GridE3" runat="server" AllowSorting="True" Style="width: 100%" CssClass="table border border-dark border-start-0 border-end-0 mb-0" AutoGenerateColumns="false" ShowHeader="true" OnRowDataBound="GridView_RowDataBound" OnRowCommand="GridCommandEventHandler">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="10%">
                                                            <HeaderTemplate>
                                                                <asp:LinkButton runat="server" ID="BTNAgregaLinea" CommandName="AgregaArticulo" CommandArgument="E3" UseSubmitBehavior="true" CssClass="btn btn-light border border-dark shadow float-end" Style="font-size: 1rem">
                                                            <i class="bi bi-box-arrow-in-right"></i>
                                                                </asp:LinkButton>
                                                            </HeaderTemplate>
                                                            <ItemTemplate>
                                            ...
                                            <div class="col-lg-3 border border-dark p-0" runat="server" id="COL_E4">
                                                ...
                                                <asp:GridView ID="GridE4" runat="server" AllowSorting="True" Style="width: 100%" CssClass="table border border-dark border-start-0 border-end-0 mb-0" AutoGenerateColumns="false" ShowHeader="true" OnRowDataBound="GridView_RowDataBound" OnRowCommand="GridCommandEventHandler">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="10%">
                                                            <HeaderTemplate>
                                                                <asp:LinkButton runat="server" ID="BTNAgregaLinea" CommandName="AgregaArticulo" CommandArgument="E4" UseSubmitBehavior="true" CssClass="btn btn-light border border-dark shadow float-end" Style="font-size: 1rem">
                                                            <i class="bi bi-box-arrow-in-right"></i>
                                                                </asp:LinkButton>
                                                            </HeaderTemplate>
                                                            <ItemTemplate>
                                            ...
                                            <div class="col-lg-3 border border-dark p-0" runat="server" id="COL_D4">
                                                ...
                                                <asp:GridView ID="GridD4" runat="server" AllowSorting="True" Style="width: 100%" CssClass="table border border-dark border-start-0 border-end-0 mb-0" AutoGenerateColumns="false" ShowHeader="true" OnRowDataBound="GridView_RowDataBound" OnRowCommand="GridCommandEventHandler">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="10%">
                                                            <HeaderTemplate>
                                                                <asp:LinkButton runat="server" ID="BTNAgregaLinea" CommandName="AgregaArticulo" CommandArgument="D4" UseSubmitBehavior="true" CssClass="btn btn-light border border-dark shadow float-end" Style="font-size: 1rem">
                                                            <i class="bi bi-box-arrow-in-right"></i>
                                                                </asp:LinkButton>
                                                            </HeaderTemplate>
                                                            <ItemTemplate>
                                            ...
                                            <div class="col-lg-3 border border-dark p-0" runat="server" id="COL_C4">
                                                ...
                                                <asp:GridView ID="GridC4" runat="server" AllowSorting="True" Style="width: 100%" CssClass="table border border-dark border-start-0 border-end-0 mb-0" AutoGenerateColumns="false" ShowHeader="true" OnRowDataBound="GridView_RowDataBound" OnRowCommand="GridCommandEventHandler">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="10%">
                                                            <HeaderTemplate>
                                                                <asp:LinkButton runat="server" ID="BTNAgregaLinea" CommandName="AgregaArticulo" CommandArgument="C4" UseSubmitBehavior="true" CssClass="btn btn-light border border-dark shadow float-end" Style="font-size: 1rem">
                                                            <i class="bi bi-box-arrow-in-right"></i>
                                                                </asp:LinkButton>
                                                            </HeaderTemplate>
                                                            <ItemTemplate>
                                            ...
                                            <div class="col-lg-3 border border-dark p-0" runat="server" id="COL_B4">
                                                ...
                                                <asp:GridView ID="GridB4" runat="server" AllowSorting="True" Style="width: 100%" CssClass="table border border-dark border-start-0 border-end-0 mb-0" AutoGenerateColumns="false" ShowHeader="true" OnRowDataBound="GridView_RowDataBound" OnRowCommand="GridCommandEventHandler">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="10%">
                                                            <HeaderTemplate>
                                                                <asp:LinkButton runat="server" ID="BTNAgregaLinea" CommandName="AgregaArticulo" CommandArgument="B4" UseSubmitBehavior="true" CssClass="btn btn-light border border-dark shadow float-end" Style="font-size: 1rem">
                                                            <i class="bi bi-box-arrow-in-right"></i>
                                                                </asp:LinkButton>
                                                            </HeaderTemplate>
                                                            <ItemTemplate>
                                            ...
                                            <div class="col-lg-3 border border-dark p-0" runat="server" id="COL_A4">
                                                ...
                                                <asp:GridView ID="GridA4" runat="server" AllowSorting="True" Style="width: 100%" CssClass="table border border-dark border-start-0 border-end-0 mb-0" AutoGenerateColumns="false" ShowHeader="true" OnRowDataBound="GridView_RowDataBound" OnRowCommand="GridCommandEventHandler">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderStyle-Width="10%">
                                                            <HeaderTemplate>
                                                                <asp:LinkButton runat="server" ID="BTNAgregaLinea" CommandName="AgregaArticulo" CommandArgument="A4" UseSubmitBehavior="true" CssClass="btn btn-light border border-dark shadow float-end" Style="font-size: 1rem">
                                                            <i class="bi bi-box-arrow-in-right"></i>
                                                                </asp:LinkButton>
                                                            </HeaderTemplate>
                                                            <ItemTemplate>
