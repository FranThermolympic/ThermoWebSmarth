<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="KPIConsultasConsumos.aspx.cs" Inherits="ThermoWeb.KPI.KPIConsultasConsumos" MasterPageFile="~/SMARTH.Master"
                    ...
                    <div class="row mt-2">                       
                        <div class="tab-content shadow" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <h5>Uso de máquina</h5>
                                        <div class="table-responsive">
                                            <asp:GridView ID="dgv_KPI_Uso_Maquina" runat="server" AllowSorting="True" margin="20px" Style="margin-left: 1%;"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Tonelaje">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblFicha" runat="server" Text='<%#Eval("C_SHORT_DESCR") %>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Horas" ItemStyle-BackColor="#EFEFEF" ItemStyle-Font-Bold="true">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblFicha" runat="server" Text='<%#Eval("TIEMPO", "{0:##}") %>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
                                    ...
                                    <div class="col-lg-6">
                                        <h5>Kgs. transformados</h5>
                                        <div class="table-responsive">
                                            <asp:GridView ID="dgv_KPI_KGTransformados" runat="server" AllowSorting="True" margin="20px" Style="margin-left: 1%;"
                                                Width="98.5%" CssClass="table table-striped table-bordered table-hover shadow p-3 mb-5" AutoGenerateColumns="false"
                                                EmptyDataText="No hay fichas para mostrar.">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Kgs." ItemStyle-BackColor="#EFEFEF" ItemStyle-Font-Bold="true">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblFicha" runat="server" Text='<%#Eval("KG", "{0:##}") %>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
