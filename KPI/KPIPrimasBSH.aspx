<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="KPIPrimasBSH.aspx.cs"
    Inherits="ThermoWeb.KPI.KPIPrimasBSH" EnableEventValidation="false" MaintainScrollPositionOnPostback="true"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>KPI - Primas BSH</title>
    <meta charset="utf-8">
            ...
            <asp:GridView ID="dgv_KPI_Operarios" runat="server" AllowSorting="True" margin="20px" Style="margin-left: 1%;"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Producidas">
                        <ItemTemplate>
                            <asp:Label ID="lblFicha" runat="server" Text='<%#Eval("PRODUCIDAS") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Horas">
                        <ItemTemplate>
                            <asp:Label ID="lblFicha" runat="server" Text='<%#Eval("HORAS") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Ratio">
                        <ItemTemplate>
                            <asp:Label ID="lblFicha" runat="server" Text='<%#Eval("RATIO") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="PRIMA">
                        <ItemTemplate>
                            <asp:Label ID="lblFicha" runat="server" Text='<%#Eval("PRIMA","{0:c}") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
